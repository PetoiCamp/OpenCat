...
''',
    ...
    'tipCheckBtn':'If you upload the firmware for NyBoard for the first time, please UPLOAD the Parameters Firmware.',
    'btnUpload': 'Upload',
    'Warning': 'Warning',
    'Uploading': 'Uploading ',
...
''',
    ...
    'tipCheckBtn':'第一次为NyBoard上传固件时，请上传参数固件',
    'btnUpload': '上传',
    'Warning': "警告",
...
''',
    ...
    'tipCheckBtn':'第一次為NyBoard上傳固件時，請上傳參數固件',
    'btnUpload': '上傳',
    'Warning': '警告',
...
''',
    ...
    'tipCheckBtn':'Wenn Sie die Firmware für NyBoard zum ersten Mal hochladen, laden Sie bitte die Parameter-Firmware HOCH.',
    'btnUpload': 'Hochladen',
    'Warning': 'Warnung',
    'Uploading': 'Hochladen ',
...
''',
    ...
    'tipCheckBtn':'หากคุณอัปโหลดเฟิร์มแวร์สำหรับ NyBoard เป็นครั้งแรก โปรดอัปโหลดเฟิร์มแวร์พารามิเตอร์',
    'btnUpload': 'อัพโหลด',
    'Warning': 'คำเตือน',
...
''',
    ...
    'tipCheckBtn':'Se carichi il firmware per NyBoard per la prima volta, CARICA il firmware dei parametri.',
