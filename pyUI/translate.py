...
'Clear':'ล้าง',
'max':'สูงสุด',
'Manual mode':'โหมดควบคุมด้วยมือ',
'Please disconnect and reconnect the device from the computer side': 'กรุณายกเลิกการเชื่อมต่อและเชื่อมต่ออุปกรณ์ใหม่จากด้านคอมพิวเตอร์',
