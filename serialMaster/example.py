...
# - 1.5 indicates the postponed time after finishing the command, in seconds. it can be float number.
                        ['m', [1, 0], 2],
                        ['m', [0, -50], 1.5],
...
# rotated to the 45 degree, and then rotated to the -45 degree.
...
# rotated to the -15, -20 degree at the same time.
# After these motion commands are completed, the next command will
# be executed after a 2-second delay.
                        ['M', ['M', '8', '-15', '9', '-20'], 2],
...
# - 255 indicates the duration, the value range is 0~255
