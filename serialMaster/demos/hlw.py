...
if __name__ == '__main__':
    try:
        ...
        testSchedule = [
            ...
            ['kbalance', 1],            # stand up
            ['i',[0,-10,8,30,12,30],0], # move three joints simutanuously
            ...
            ['ktrF', 2],  # trot forward, run upside down
            ['C',[127,  0,  0, E_RGB_ALL,  E_EFFECT_NONE],  0] # change eyes to red for the next round of shooting
        ]
